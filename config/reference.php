 ...
 *     },
 * }
 * @psalm-type PmsnzObjectTranslationConfig = array{
 *     translation_class: string, // The class name of your Translation entity.
 *     cache?: bool|array{ // Cache settings for object translations.
 *         enabled?: bool, // Default: true
 *         pool?: string, // The cache pool to use for storing object translations. // Default: null
 *         ttl?: int, // The time-to-live for cached translations, in seconds. null for no expiration. // Default: null
 *     },
 *     fallbacks?: array<string, mixed>,
 * }
 ...
 *     pms-nz_object_translation?: PmsnzObjectTranslationConfig,
